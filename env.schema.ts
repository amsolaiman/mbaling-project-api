...
export const envSchema = Yup.object({
  ...
  // JWT TOKEN
  JWT_SECRET_ACCESS_KEY: Yup.string().required('JWT_SECRET_ACCESS_KEY is required'),
  JWT_SECRET_REFRESH_KEY: Yup.string().required('JWT_SECRET_REFRESH_KEY is required'),
  JWT_ACCESS_EXPIRATION: Yup.string()
    .matches(/^\d+[smhd]$/, 'JWT_ACCESS_EXPIRATION must be a number followed by s, m, h, or d')
    .required('JWT_ACCESS_EXPIRATION is required'),
  JWT_REFRESH_EXPIRATION: Yup.string()
    .matches(/^\d+[smhd]$/, 'JWT_REFRESH_EXPIRATION must be a number followed by s, m, h, or d')
